...
/**
 * Agorax — Le Cut (élimination avant la finale AGORAX)
...
interface LeCutModalProps {
  ...
  onProceedToFinale: (finalist1: AgoraxPlayer, finalist2: AgoraxPlayer) => void;
}
...
export function LeCutModal({
  ...
  const [sauvetageWinner, setSauvetageWinner] = useState<AgoraxPlayer | null>(null);
  ...
  function handleSauvetageAnswer(player: AgoraxPlayer, index: number) {
