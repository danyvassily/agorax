...
export interface DiscoveryPack { id: string; title: Text; description: Text; mascot: string; adult?: boolean; cards: DiscoveryCard[] }
...
export const DISCOVERY_PACKS: DiscoveryPack[] = [
  { id: "couple-light", mascot: "poppy", title: t("Couple · Complicité", "Couples · Connection"), description: t("Souvenirs, petites attentions et projets à deux.", "Memories, small gestures and plans together."), cards: cards("connection", [
  ...
  { id: "couple-deep", mascot: "leo", title: t("Couple · Vraies discussions", "Couples · Deeper conversations"), description: t("Besoins, limites et écoute, sans chercher un gagnant.", "Needs, boundaries and listening, without a winner."), cards: cards("deep", [
  ...
  { id: "couple-adult", mascot: "poppy", adult: true, title: t("Couple · Intimité 18+", "Couples · Intimacy 18+"), description: t("Désirs et consentement entre adultes volontaires. Aucun défi imposé.", "Desires and consent between willing adults. No compulsory dares."), cards: cards("intimacy", [
  ...
  { id: "wellbeing-checkin", mascot: "sora", title: t("Bien-être · Faire le point", "Well-being · Check-in"), description: t("Questions de réflexion, sans diagnostic ni note.", "Reflection questions, without diagnosis or a score."), cards: cards("checkin", [
  ...
  { id: "wellbeing-practice", mascot: "neo", title: t("Bien-être · Petite pause", "Well-being · Small pause"), description: t("Exercices facultatifs, à adapter à ton confort.", "Optional exercises to adapt to your comfort."), cards: cards("practice", [
  ...
  { id: "astro-quiz", mascot: "luma", title: t("Astro · Quiz des traditions", "Astro · Traditions quiz"), description: t("Culture astrologique, pas de prédiction scientifique.", "Astrological culture, not scientific predictions."), cards: cards("astroquiz", [
  ...
  { id: "astro-play", mascot: "barnaby", title: t("Astro · Portraits imaginaires", "Astro · Imaginary portraits"), description: t("Inventez votre duo cosmique, juste pour le plaisir.", "Invent your cosmic duo, just for fun."), cards: cards("astroplay", [
