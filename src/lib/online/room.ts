/**
 * Agorax — Online room helpers (multijoueur en ligne)
...
export async function hostPushQuestion(
  ...
  const translations = question.translations?.en
    ? question.translations
    : {
        ...(question.translations ?? {}),
        en: translateQuestionToEnglish(question),
      };
  ...
  const payload = revealed
    ? {
        ...
        acceptedTypedAnswers: question.acceptedTypedAnswers,
        progressiveClues: question.progressiveClues,
