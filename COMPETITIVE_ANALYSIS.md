...
| Application | Forces | Faiblesses | Opportunité Agorax |
|---|---|---|---|
...
1. **Répétition des questions** → Agorax : sélection par score, familles, historique persistant
...
## Ce que Agorax fait différemment
