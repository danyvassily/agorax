# Graph Report - Agorax  (2026-08-16)
...
- Agorax — Base de données (Supabase / PostgreSQL)
- Core Principles
- Décisions clés
- Agorax — Debate Engine
- Tasks — Agorax Core
- Agorax — Question Engine
- 🎉 Agorax
...
- Agorax — Specification Compliance
- speckit-constitution/SKILL.md
- Agorax — Analyse concurrentielle (spec §10)
- Contributing — Agorax
- Agorax — Project Constitution
- Implementation Plan — Agorax Core
...
9. `🎉 Agorax — FINAL REPORT` - 14 edges
...
### Community 13 - "🎉 Agorax — FINAL REPORT"
Cohesion: 0.13
Nodes (14): Architecture, Debate Engine, Déploiement, 🎉 Agorax — FINAL REPORT, GitHub, Performance (mesures réelles), Product, Product Critic (+6 more)
...
### Community 19 - "Agorax — Base de données (Supabase / PostgreSQL)"
Cohesion: 0.18
Nodes (10): Débats (spec §56), Agorax — Base de données (Supabase / PostgreSQL), Index, Jeu, Migrations, NOT VERIFIED, Principes (spec §13–§15), Questions (spec §14, §38, §41) (+2 more)
...
Cohesion: 0.20
Nodes (9): 1. Local-first (spec §27), 2. Anti-répétition serveur (spec §37), 3. Machine à états de débat (spec §58), 4. Stack, Arborescence, Décisions clés, Extensibilité (spec §39, §40), Agorax — Architecture (+1 more)

### Community 22 - "Agorax — Debate Engine"
Cohesion: 0.20
Nodes (10): Confidentialité (spec §80), Debate Quality Agent (spec §76) — audit automatique, Fair speaking timer (spec §59), Agorax — Debate Engine, Machine à états (spec §58), Modes (spec §71–§73), Principes (spec §56–§80), Prompt de débat (spec §56) (+2 more)

### Community 23 - "Tasks — Agorax Core"
Cohesion: 0.20
...
### Community 24 - "Agorax — Question Engine"
Cohesion: 0.22
Nodes (9): Anti-répétition (spec §37) — LE CŒUR, Dataset actuel, Agorax — Question Engine, Garde-fous du schéma (Zod `superRefine`), Pipeline CLI (`npm run questions:*`), Principes (spec §17–§42), Schéma de question (extrait, spec §28), Sources (spec §18, §23–§26) (+1 more)

### Community 25 - "🎉 Agorax"
Cohesion: 0.22
Nodes (9): 📚 Documentation, 🚀 Démarrage, 🎉 Agorax, 📄 Licence des données, ✨ Modes de jeu, ❓ Pipeline des questions, 📁 Structure, 🔒 Sécurité (+1 more)
...
Cohesion: 0.25
Nodes (7): Critères d'acceptation, Feature Spec — Agorax Core, P1 — Jouer immédiatement (MVP jouable, zéro compte), P2 — Débattre sérieusement, P3 — Connaissance & contenu, P4 — Supabase (persistance optionnelle), User stories
...
### Community 32 - "Agorax — Specification Compliance"
Cohesion: 0.29
Nodes (7): Backend / Sécurité / QA, Debate Engine, Agorax — Specification Compliance, Modes & UI/UX, Piliers produit, Question Engine, Récapitulatif
...
### Community 34 - "Agorax — Analyse concurrentielle (spec §10)"
Cohesion: 0.33
Nodes (5): Ce que Agorax fait différemment, Agorax — Analyse concurrentielle (spec §10), Marché observé, Points de douleur des utilisateurs (avis publics), Positionnement cible

### Community 35 - "Contributing — Agorax"
Cohesion: 0.33
Nodes (5): Ajouter des questions, Ajouter un débat, Contributing — Agorax, Sécurité, Workflow

### Community 36 - "Agorax — Project Constitution"
Cohesion: 0.33
Nodes (5): 1. Mission, 2. Non-négociables (dans l'ordre), 3. Contraintes, 4. Définition de done, Agorax — Project Constitution

### Community 37 - "Implementation Plan — Agorax Core"
Cohesion: 0.33
Nodes (5): Architecture, Décisions d'ingénierie, Implementation Plan — Agorax Core, Stack, Étapes
