-- ============================================================
-- AGORAX / Agorax — Schema Extension (spec §2–§15, §28)
--
-- Ajout des structures de données pour le mode AGORAX :
-- 1. Profils : spécialité, ligue, points de saison, statistiques
-- 2. Parties & Salons : mode 'agorax', durée express/classique, finale La Ligne, buzzer
...
alter table public.games add constraint games_mode_check
  check (mode in ('agorax','classic','truefalse','rapidfire','timeline','teambattle','wyr','guess','debate'));

-- ---------- 3. Game Sessions : AGORAX & La Ligne ----------
