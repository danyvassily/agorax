...
Agorax est une application web mobile-first de jeu social : quiz, culture générale, mythologies, défis intellectuels et **débats profonds** — conçue pour les soirées entre amis, sans inscription, prête en 5 secondes.
...
```bash
git clone https://github.com/danyvassily/Agorax.git
cd Agorax
npm install
npm run dev
```
...
- Questions : faits structurés (licence CC0 / Wikidata) + contenus originaux rédigés pour Agorax
